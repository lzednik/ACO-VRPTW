...
#                                    feasLocs.remove(tour[vehicle['currPos']])
                        ...
                        matr=max(attractL0.values())

                        attr0Sum=0
                        for loc in attractL0:
                            attr0Sum+=(phiM[vehicle['currPos']][loc])*matr/(attractL0[loc])**2
                    
                        for loc in attractL0:
                            attractL1[loc]=((phiM[vehicle['currPos']][loc])*matr/(attractL0[loc])**2)/attr0Sum
                        
                        minva1=min(attractL1.values())
                        for loc in attractL1:
                            attractL1[loc]=int(attractL1[loc]/minva1)
